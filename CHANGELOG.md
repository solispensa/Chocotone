...
- **Encoder Pin Conflict Fix** - Rewrote conflict resolution to handle pins individually, allowing user-defined swaps to persist unless specifically conflicting.
