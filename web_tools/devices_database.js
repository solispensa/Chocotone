...
const SYSEX_SCROLL_PARAMS = {
    ...
    "Valeton GP-5": {
        "PITCH - HIGH": [
            ...
            "8080f00C0F00010000000E01010408000600000000000000010000000000000000000000000400f7",
            "8080f0090400010000000E01010408000600000000000000010000000000000000000004000400f7",
            "8080f0070900010000000E01010408000600000000000000010000000000000000000008000400f7",
            "8080f00D0700010000000E0101040800060000000000000001000000000000000000000a000400f7",
            "8080f0020200010000000E0101040800060000000000000001000000000000000000000c000400f7",
            "8080f0080C00010000000E0101040800060000000000000001000000000000000000000e000400f7",
            "8080f00C0800010000000E01010408000600000000000000010000000000000000000000000401f7",
            "8080f0090F00010000000E01010408000600000000000000010000000000000000000001000401f7",
            "8080f0060600010000000E01010408000600000000000000010000000000000000000002000401f7",
            "8080f0030100010000000E01010408000600000000000000010000000000000000000003000401f7",
            "8080f0090300010000000E01010408000600000000000000010000000000000000000004000401f7",
            "8080f00C0400010000000E01010408000600000000000000010000000000000000000005000401f7",
            "8080f0030D00010000000E01010408000600000000000000010000000000000000000006000401f7",
            "8080f0060A00010000000E01010408000600000000000000010000000000000000000007000401f7",
            "8080f0070E00010000000E01010408000600000000000000010000000000000000000008000401f7",
            "8080f00D0600010000000E01010408000600000000000000010000000000000000000008080401f7",
            "8080f0020900010000000E01010408000600000000000000010000000000000000000009000401f7",
            "8080f0080100010000000E01010408000600000000000000010000000000000000000009080401f7",
            "8080f00D0000010000000E0101040800060000000000000001000000000000000000000a000401f7",
            "8080f0070800010000000E0101040800060000000000000001000000000000000000000a080401f7",
            "8080f0080700010000000E0101040800060000000000000001000000000000000000000b000401f7",
            "8080f0020F00010000000E0101040800060000000000000001000000000000000000000b080401f7",
            "8080f0020500010000000E0101040800060000000000000001000000000000000000000c000401f7"
        ]
    }
};

// Get SysEx scroll parameter list for a device
function getSysexScrollParams(deviceName) {
    return SYSEX_SCROLL_PARAMS[deviceName] || {};
}

// Get list of available SysEx scroll parameters for a device
function getSysexScrollParamList(deviceName) {
    const params = getSysexScrollParams(deviceName);
    return Object.keys(params);
}

// Get a specific SysEx scroll parameter list
function getSysexScrollParamMessages(deviceName, paramName) {
    const params = getSysexScrollParams(deviceName);
...
if (typeof window !== 'undefined') {
    ...
    window.getSysexScrollParams = getSysexScrollParams;
    window.getSysexScrollParamList = getSysexScrollParamList;
    window.getSysexScrollParamMessages = getSysexScrollParamMessages;
}
